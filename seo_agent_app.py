...
SEO_PROMPT_TEMPLATE = """Ти — спеціаліст з SEO-оптимізації контенту. Твоє завдання — автоматично перетворити опис відео в якісний, зрозумілий та добре оптимізований для пошукових систем текст. Виконуй завдання, дотримуючись наступних інструкцій:
...
5  **Формат виведення:** Надай відповідь чітко розділяючи основний SEO-текст, Мета-заголовок та Мета-опис. Наприклад:
...
st.title("🤖 ArmyTV. Лейтенант ШІ оптимізує твоє життя")
st.markdown("""
Я допоможу тобі перетворити опис на інформативний та структурований текст, який буде краще
...
if st.session_state.seo_text:
    st.header("💡 Лейтенант ШІ оптимізував текст")
